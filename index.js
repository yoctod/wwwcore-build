 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`wwwcore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`wwwcore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'wwwcore-' + name : 'wwwcore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/wwwcore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external wwwcore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:wwwcore-lib -o wwwcore-lib.js';
    }
